...
and to solve this apply log transformation on target variable when it has skewed distribution.
 That being said, you need to apply inverse function on top of the predicted values to get the actual predicted target value.
"""
...
sns.distplot(np.log(train.SalePrice), color='purple')
